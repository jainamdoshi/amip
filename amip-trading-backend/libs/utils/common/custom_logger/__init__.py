...
from libs.utils.common.custom_logger.helper import (
    color_string,
...
class CustomLogger:
    ...
    def log_function_call(
        ...
        self.root_logger.debug(f"Function called...", extra=extra)
    ...
    def log_function_return(
        ...
        self.root_logger.debug(f"Function returned", extra=extra)
